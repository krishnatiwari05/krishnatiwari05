...
<img src="https://readme-typing-svg.herokuapp.com?font=Poppins&weight=600&size=24&pause=1000&color=00C2FF&center=true&vCenter=true&width=800&lines=Turning+Data+Into+Insights+📈;Excel+%7C+SQL+%7C+Python+%7C+Power+BI;Building+Dashboards+and+Analytics+Projects;Passionate+About+Data+Visualization+🚀" />
...
| 📌 Project | 🔥 Description |
|---|---|
| 📊 Sales Dashboard | Interactive Power BI dashboard for business insights |
| 🐍 Python Data Cleaning | Automated cleaning & preprocessing using Python |
| 🗄️ SQL Business Analysis | Advanced SQL queries for analytics |
| 📈 Excel Reporting | Automated Excel reports & visualizations |
